...
if(count($inventoryToDisplay))
{
	foreach($inventoryToDisplay as $car)
	{
		...
		<div>
		<a href="<?php echo $detailURL;?>" title="<?php echo $car->Year.' '.$car->Make.' '.$car->Model.' '.$car->Trim;?>"><img border="0" src="<?php echo $car->ImageUrls[0];?>"></a>
		<ul>
		  <li><a href="<?php echo $detailURL;?>"><?php echo $car->Year.' '.$car->Make.' '.$car->Model.' '.$car->Trim;?></a></li>
		  <li><?php echo $car->ExteriorColor;?></li>
		  <li><?php echo $car->Mileage;?></li>
