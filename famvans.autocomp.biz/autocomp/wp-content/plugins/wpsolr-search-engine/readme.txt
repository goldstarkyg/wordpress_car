...
Search like Google Site Search with Elasticsearch or Solr search. No longer reserved for the biggest brands.

== Description ==
WPSOLR is a pure search plugin working with your Elasticsearch or Solr server (if you're looking for a hosted search, you should have a look to solutions like Algolia, swiftype, searchIQ, or Instantsearch+).
