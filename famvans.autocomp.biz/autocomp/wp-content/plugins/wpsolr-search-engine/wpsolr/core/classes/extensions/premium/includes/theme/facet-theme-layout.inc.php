...
$facets_layout_available = apply_filters( WPSOLR_Events::WPSOLR_FILTER_GET_FIELD_TYPE_LAYOUTS,
	[
...
<div class="wdm_row" style="top-margin:5px;">
    ...
    <div class='col_right'>
		...
		include 'facet-theme-layout-range-regular.inc.php';
		include 'facet-theme-layout-range-irregular.inc.php';
		include 'facet-theme-layout-color-picker.inc.php';
