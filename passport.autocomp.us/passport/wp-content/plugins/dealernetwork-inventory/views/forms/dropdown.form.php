...
<option value="" style="display:none;" selected>Select a year</option>
<option value="">--</option>
</select>
<select id="make" name='mk' placeholder="Select a make">
<option value="" style="display:none;" selected>Select a make</option>
<option value="">--</option>
</select>
<select id="model" name='md' placeholder="Select a model">
<option value="" style="display:none;" selected>Select a model</option>
<option value="">--</option>
</select>
