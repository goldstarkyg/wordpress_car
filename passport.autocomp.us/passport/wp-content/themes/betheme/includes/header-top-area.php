	...
	<div id="Action_bar">
		<div class="container">
			<div class="column one">
				...
				<ul style="margin-left:60%;" class="contact_details">
					<?php
						if( $header_slogan = mfn_opts_get( 'header-slogan' ) ){
							echo '<li class="slogan"><a style="color:white" href="#maps">'. $header_slogan .'</a></li>';
						}					
						if( $header_email = mfn_opts_get( 'header-email' ) ){
							echo '<a style="color:white" href="mailto:passportmotors@hotmail.com"><li class="mail"><i class="icon-mail-line"></i></a></li></a>';
						}
						if( $header_phone = mfn_opts_get( 'header-phone' ) ){
							echo '<li class="phone"><i class="icon-phone"></i><a style="color:white" href="tel:'. str_replace(' ', '', $header_phone) .'">'. $header_phone .'</a></li>';
						}					
		...
		<div class="column one">
			...
			<div class="top_bar_right">
				<div class="top_bar_right_wrapper">
					<?php echo do_shortcode("[dealernetwork-inventory-customer]"); ?>
				</div>
			</div>			
		</div>
	</div>
